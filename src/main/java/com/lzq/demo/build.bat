...
set apollo_config_db_url="jdbc:mysql://192.168.50.200:3306/ApolloConfigDB_DEV?characterEncoding=utf8"
set apollo_config_db_username="root"
set apollo_config_db_password="root"

rem apollo portal db info
set apollo_portal_db_url="jdbc:mysql://192.168.50.200:3306/ApolloPortalDB_NEW?characterEncoding=utf8"
set apollo_portal_db_username="root"
set apollo_portal_db_password="root"

rem meta server url, different environments should have different meta server addresses
set dev_meta="http://192.168.50.200:8080"
set fat_meta="http://192.168.50.200:8081"
set uat_meta="http://192.168.50.200:8082"
set pro_meta="http://192.168.50.200:8083"
